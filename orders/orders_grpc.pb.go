...
type OrdersInfoClient interface {
	...
	AutoMigrate(ctx context.Context, in *CreateOrderParams, opts ...grpc.CallOption) (*OrdersSuccess, error)
}
...
func (c *ordersInfoClient) AutoMigrate(ctx context.Context, in *CreateOrderParams, opts ...grpc.CallOption) (*OrdersSuccess, error) {
	out := new(OrdersSuccess)
	err := c.cc.Invoke(ctx, "/OrdersInfo/autoMigrate", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type OrdersInfoServer interface {
	...
	AutoMigrate(context.Context, *CreateOrderParams) (*OrdersSuccess, error)
...
func (UnimplementedOrdersInfoServer) AutoMigrate(context.Context, *CreateOrderParams) (*OrdersSuccess, error) {
...
func _OrdersInfo_AutoMigrate_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(CreateOrderParams)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(OrdersInfoServer).AutoMigrate(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/OrdersInfo/autoMigrate",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(OrdersInfoServer).AutoMigrate(ctx, req.(*CreateOrderParams))
	}
	return interceptor(ctx, in, info, handler)
}
...
var OrdersInfo_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _OrdersInfo_AutoMigrate_Handler,
		},
	},
