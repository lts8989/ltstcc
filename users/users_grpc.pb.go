...
type UsersInfoClient interface {
	...
	AutoMigrate(ctx context.Context, in *Users, opts ...grpc.CallOption) (*UsersSuccess, error)
}
...
func (c *usersInfoClient) AutoMigrate(ctx context.Context, in *Users, opts ...grpc.CallOption) (*UsersSuccess, error) {
	out := new(UsersSuccess)
	err := c.cc.Invoke(ctx, "/UsersInfo/autoMigrate", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type UsersInfoServer interface {
	...
	AutoMigrate(context.Context, *Users) (*UsersSuccess, error)
...
func (UnimplementedUsersInfoServer) AutoMigrate(context.Context, *Users) (*UsersSuccess, error) {
...
func _UsersInfo_AutoMigrate_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(Users)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(UsersInfoServer).AutoMigrate(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/UsersInfo/autoMigrate",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(UsersInfoServer).AutoMigrate(ctx, req.(*Users))
	}
	return interceptor(ctx, in, info, handler)
}
...
var UsersInfo_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _UsersInfo_AutoMigrate_Handler,
		},
	},
